    ...
    <div className="xl:flex my-14 xl:items-center">
      ...
      <div className="space-y-7 xl:ml-7 xl:w-3/5 xl:flex xl:flex-col xl:space-y-10">
        ...
        <div className="xl:flex xl:flex-col space-y-4">
          ...
          <OtherButton>
            Hi there, <br />
            I'm Larissa Castelluber, and I'm dedicated to helping you achieve
            your Canadian dream. I understand the challenges of the immigration
            process and am here to provide you with the support and guidance you
            need. Let's make your journey to Canada a successful and fulfilling
            one!
          </OtherButton>
        </div>
      </div>
